  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center px-4 py-8 relative">
      <div className="w-full max-w-md text-center">
        ...
        <h1 className="text-2xl font-bold mb-2 text-white">{t('suspendedTitle')}</h1>
        <p className="text-slate-400 mb-6">
          {t('suspendedDesc')}
        </p>
        <p className="text-sm text-slate-500 mb-4">
          {t('supportEmail')} <a href="mailto:support@medjira.com" className="text-primary hover:underline">support@medjira.com</a>
        </p>
