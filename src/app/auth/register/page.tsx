...
export default function RegisterPage() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      if (!userDoc.exists()) {
        // Créer le document utilisateur pour les nouveaux comptes
        ...
        console.log('✅ Compte client créé avec Google:', user.uid);
      } else {
        console.log('✅ Connexion avec compte Google existant');
      }
