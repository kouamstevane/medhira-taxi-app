      ...
      <div className="max-w-[430px] mx-auto min-h-screen flex flex-col">
        ...
        <main className="flex-1 p-4 space-y-4">
          <div className={`flex items-center gap-2 text-sm ${isOnline ? 'text-green-400' : 'text-slate-500'}`}>
            ...
            {isOnline ? t('client.courierOnTheWay') : t('client.positionUnavailable')}
          </div>
          ...
          <div className="glass-card rounded-2xl p-6 border border-white/5">
            <h2 className="text-lg font-bold text-white mb-4">{t('food.deliveryDetails')}</h2>
            <div className="space-y-4 relative">
              ...
              {order?.restaurantAddress && (
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[10px] text-slate-500 uppercase font-bold">{t('food.restaurant')}</p>
              ...
              {order?.clientAddress && (
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[10px] text-slate-500 uppercase font-bold">{t('food.destination')}</p>
            ...
            {order?.orderNumber && (
              <div className="border-t border-white/5 pt-4 mt-4">
                <div className="flex justify-between text-sm">
                  <span className="text-slate-400">{t('food.order')}</span>
          ...
          {!driverLocation && (
            <div className="glass-card rounded-2xl border border-white/10 p-6 text-center">
              ...
              <p className="text-slate-500">{t('food.courierNotStarted')}</p>
            </div>
          )}
        </main>
      </div>
