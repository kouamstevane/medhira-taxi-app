...
export default function Level6_ArrivedClient({ order, confirmDelivery, uploadProofPhoto }: Props) {
  switch (order.deliveryPreference) {
    case 'meet_outside':
      return <Level7B_MeetOutside order={order} confirmDelivery={confirmDelivery} />
    case 'meet_at_door':
      return <Level7C_MeetAtDoor order={order} confirmDelivery={confirmDelivery} />
    default:
