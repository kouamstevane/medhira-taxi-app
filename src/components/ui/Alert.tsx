...
/**
 * Composant d'alerte avec différents types et option de fermeture
 */
export const Alert: React.FC<AlertProps> = ({
  ...
  return (
    <div className={`${bg} border-l-4 ${border} ${text} p-4 rounded-md flex items-center justify-between ${className}`}>
