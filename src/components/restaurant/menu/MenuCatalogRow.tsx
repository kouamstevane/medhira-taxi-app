    ...
    <div className={`grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-3 border-b border-white/[0.06] px-3 py-3 transition md:grid-cols-[auto_minmax(0,1fr)_160px_120px_140px_auto] md:gap-4 md:px-4 ${selected ? 'bg-primary/[0.06]' : 'hover:bg-white/[0.025]'} ${!item.isAvailable ? 'opacity-65' : ''}`}>
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          onClick={() => onToggleAvailability(item)}
          aria-label={item.isAvailable ? t('makeUnavailableNamed', { name: item.name }) : t('makeAvailableNamed', { name: item.name })}
          className="flex size-11 items-center justify-center rounded-xl text-slate-500 transition hover:bg-white/[0.07] hover:text-emerald-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary md:hidden"
        >
        ...
        <button
          ...
          className="flex size-11 items-center justify-center rounded-xl text-slate-500 transition hover:bg-blue-500/10 hover:text-blue-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
        >
        ...
        <button
          ...
          className="flex size-11 items-center justify-center rounded-xl text-slate-500 transition hover:bg-red-500/10 hover:text-red-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
        >
